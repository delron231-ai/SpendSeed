...
export const ModelSection: React.FC = () => {
  return (
    <section id="model" className="w-full py-[56px] sm:py-[80px] md:py-[120px] bg-[#F2F4F1]">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <p className="body-copy font-sans-body text-[#404943] text-[17px] leading-[1.6] max-w-[65ch]">
            Most micro-investing apps charge S$2–S$5 a month on a S$100 balance. That's a 24% to 60% annual fee drag. We aligned our incentives with your stillness instead.
          </p>
        </motion.div>

        {/* 3 Model Cards (Requirement 7: stack vertically on mobile) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-16">
          ...
          <motion.div
            ...
            className="flex flex-col gap-4 bg-[#F8FAF7] p-8 rounded-xl border border-[#D9A521] justify-between shadow-xs"
          >
            <div className="flex flex-col gap-2">
              <span className="mono-caption font-mono-code text-[12px] text-[#906a0c] font-semibold">
                TIER 2 · PARTNERS
              </span>
              <div className="font-serif-display text-4xl sm:text-5xl font-semibold text-[#D9A521] tabular-nums my-1">
                4.8%
              </div>
              <h3 className="font-serif-display text-xl font-medium text-[#191C1B]">
                Merchants pay us
            ...
            <p className="body-copy font-sans-body text-[#404943] text-[15px] sm:text-[16px] leading-[1.6]">
              We negotiate rebates from ethical partners when you deploy your Goal funds with them.
            </p>
          </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pt-6">
          <div className="p-6 bg-[#F8FAF7] rounded-xl border border-[#DCE3DD] flex flex-col gap-2">
